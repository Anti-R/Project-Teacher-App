  ...
  return (
    ...
    <View style={styles.container}>
         ...
         <TouchableOpacity style={styles.Btn}
          ...
          <Text style={{color:"white"}}>Add-SchoolData From excelSheet</Text>
         </TouchableOpacity>
         ...
         >
          <Text style={{color:"white"}}>Add Subject</Text>
         </TouchableOpacity>
         
         
         <TouchableOpacity style={styles.Btn}
          onPress={()=>{this.props.navigation.navigate('StudentAffair')}}>
         
          <Text style={{color:"white"}}>Student-Affair</Text>
         </TouchableOpacity>
